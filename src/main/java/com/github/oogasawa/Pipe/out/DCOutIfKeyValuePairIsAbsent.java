...
public class DCOutIfKeyValuePairIsAbsent implements Out {
	...
	public DCOutIfKeyValuePairIsAbsent(DCContainerFactory facObj, String dbName, String ds, String pred) throws IOException {
		try {
			dbObj = facObj.getInstance(dbName);
		} catch (ConfigurationException e) {
			logger.throwing("com.github.oogasawa.Pipe.out.DCOutIfKeyValuePairIsAbsent", "constructor", e);
			logger.warning("Runtime exception in a DCOutIfKeyValuePairIsAbsent constructor. ");
		}
		this.ds   = ds;
		this.pred = pred;
	}
	...
	public void putLine(String line) {
		...
		dbObj.putRowIfKeyValuePairIsAbsent(ds, col.get(0), pred, col.get(1));
	}
