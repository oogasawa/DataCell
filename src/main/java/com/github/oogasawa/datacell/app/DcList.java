...
abstract public class DcList {
    ...
    public void listRows(String dbName, String dataSet, String predicate) {
        ...
        try {
            ...
            logger.throwing("com.github.oogasawa.datacell.app.DcList", "listRows", e);
            logger.warning("Can not open the database " + dbName);
        } finally {
            dbObj.close();
        }
    }
    ...
    public void listDataSets(String dbName) {
        ...
        try {
            ...
            logger.throwing("com.github.oogasawa.datacell.app.DcList", "listDataSets", e);
            logger.warning("Can not open the database " + dbName);
        } finally {
            dbObj.close();
        }
    ...
    public void listPredicates(String dbName, String dataSet) {
        ...
        try {
            ...
            logger.throwing("com.github.oogasawa.datacell.app.DcList", "listPredicates", e);
            logger.warning("Can not open the database " + dbName);
        } finally {
            dbObj.close();
        }
